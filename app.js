        ...
        function updateCliente(cliente) { return new Promise((resolve) => { let tx = db.transaction('clienti', 'readwrite'); tx.objectStore('clienti').put(cliente); tx.oncomplete = () => resolve(); }); }
        ...
        window.selezionaClienteStatistica = function (schedaCliente) {
            ...
            venditeCliente.forEach(v => {
                ...
                // Calcolo data ultimo bonus (essendo ordinate dalla più recente, il primo che troviamo > 0 è l'ultimo in ordine di tempo)
            ...
            document.getElementById('stat-det-ultimo-bonus').textContent = dataUltimoBonus !== "-" ? dataUltimoBonus : "Mai riscattato";
